...
import { LOCATIONS_QUERY, LOCATION_EXISTS_QUERY, SINGLE_LOCATION_QUERY } from '../queriesAndMutations/locations/locationQueries'
...
const queries = {
    ...
    locations: {
        exists: LOCATION_EXISTS_QUERY, // query to locationS, not location
